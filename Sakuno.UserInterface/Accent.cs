...
namespace Sakuno.UserInterface
{
    public class Accent
    {
        ...
        public static Accent Brown { get; } = new Accent("Blue", new Uri("pack://application:,,,/Sakuno.UserInterface;component/Themes/Accents/Brown.xaml"));

        public string Name { get; }

        public ResourceDictionary ResourceDictionary { get; }

        Accent(string rpName, Uri rpUri)
        {
            Name = rpName;
