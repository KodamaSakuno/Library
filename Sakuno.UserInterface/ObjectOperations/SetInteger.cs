...
{
    public class SetInteger : ObjectOperation
    {
        public static readonly DependencyProperty PropertyProperty = DependencyProperty.Register(nameof(Property), typeof(string), typeof(SetInteger),
        ...
        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register(nameof(Value), typeof(int), typeof(SetInteger),
        ...
        protected override Freezable CreateInstanceCore() => new SetInteger();
    }
}
